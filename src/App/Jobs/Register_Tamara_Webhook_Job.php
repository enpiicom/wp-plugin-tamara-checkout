			...
			try {
				...
				throw new Exception(
					sprintf(
						...
						$RegisterWebhookException->getMessage(),
						$RegisterWebhookException->getTraceAsString()
					)
				);
			}
		}
