...
namespace Tamara_Checkout\Deps\Symfony\Component\HttpFoundation\Session\Storage\Handler;
...
class PdoSessionHandler extends AbstractSessionHandler
{
    ...
    private function buildDsnFromUrl(#[\SensitiveParameter] string $dsnOrUrl): string
    {
        ...
        // TCO_Override the default username and password. Values passed through options will still win over these in the constructor.
