...
use Tamara_Checkout\Deps\Symfony\Component\HttpFoundation\Exception\BadRequestException;
use Tamara_Checkout\Deps\Symfony\Component\HttpFoundation\Exception\UnexpectedValueException;
...
final class InputBag extends ParameterBag
{
    ...
    {
        if (null !== $default && !\is_scalar($default) && !$default instanceof \TCO_Stringable) {
        ...
        if (null !== $value && $this !== $value && !\is_scalar($value) && !$value instanceof \TCO_Stringable) {
    ...
    {
        if (null !== $value && !\is_scalar($value) && !\is_array($value) && !$value instanceof \TCO_Stringable) {
