...
namespace Tamara_Checkout\Deps\Symfony\Component\HttpFoundation;

use Tamara_Checkout\Deps\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use Tamara_Checkout\Deps\Symfony\Component\HttpFoundation\Exception\JsonException;
use Tamara_Checkout\Deps\Symfony\Component\HttpFoundation\Exception\SessionNotFoundException;
use Tamara_Checkout\Deps\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
use Tamara_Checkout\Deps\Symfony\Component\HttpFoundation\Session\SessionInterface;
...
class Request
{
     ...
     *
     * If the X-HTTP-Method-TCO_Override header is set, and if the method is a POST,
    ...
    private static function createRequestFromFactory(array $query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null): static
    {
        if (self::$requestFactory) {
            ...
            if (!$request instanceof self) {
                throw new \LogicException('The Request factory must return an instance of Tamara_Checkout\Deps\Symfony\Component\HttpFoundation\Request.');
            }
