...
use Tamara_Checkout\Deps\Psr\Http\Client\ClientExceptionInterface;
...
class HttpClient
{
    ...
    private function request(string $method, string $path, array $params = []): ?ResponseInterface
    {
        ...
        $headers = [
            'User-Agent'    => sprintf('Tamara_Checkout\Deps\Tamara Client SDK %s, PHP version %s', Client::VERSION, phpversion()),
