...
namespace Tamara_Checkout\Deps\Nyholm\Psr7\Factory;

use Http\Message\{MessageFactory, StreamFactory, UriFactory};
use Tamara_Checkout\Deps\Nyholm\Psr7\{Request, Response, Stream, Uri};
...
if (!\interface_exists(MessageFactory::class)) {
    throw new \LogicException('You cannot use "Tamara_Checkout\Deps\Nyholm\Psr7\Factory\HttplugFactory" as the "php-http/message-factory" package is not installed. Try running "composer require php-http/message-factory". Note that this package is deprecated, use "psr/http-factory" instead');
}

@\trigger_error('Class "Tamara_Checkout\Deps\Nyholm\Psr7\Factory\HttplugFactory" is deprecated since version 1.8, use "Tamara_Checkout\Deps\Nyholm\Psr7\Factory\Psr17Factory" instead.', \E_USER_DEPRECATED);
