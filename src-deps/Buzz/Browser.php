...
namespace Tamara_Checkout\Deps\Buzz;

use Tamara_Checkout\Deps\Buzz\Client\BuzzClientInterface;
use Tamara_Checkout\Deps\Buzz\Exception\ClientException;
use Tamara_Checkout\Deps\Buzz\Exception\InvalidArgumentException;
use Tamara_Checkout\Deps\Buzz\Exception\LogicException;
use Tamara_Checkout\Deps\Buzz\Middleware\MiddlewareInterface;
