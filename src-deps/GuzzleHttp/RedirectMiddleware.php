...
use Tamara_Checkout\Deps\GuzzleHttp\Exception\BadResponseException;
use Tamara_Checkout\Deps\GuzzleHttp\Exception\TooManyRedirectsException;
 ...
 * {@see \Tamara_Checkout\Deps\GuzzleHttp\Middleware::redirect()}.
 *
 * @final
 */
